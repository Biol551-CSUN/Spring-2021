...
Your script should be divided into 5 (ish) subsections (depending onw what you are doing)
...
- Copy the **"weightdata.csv"** file from the Spring-2021 repo into your own private repo.  Put it in the **data** folder within **Week_2**.  
...
Complete all 3 before Monday at 9am.  Feel free to ask your classmates for help
