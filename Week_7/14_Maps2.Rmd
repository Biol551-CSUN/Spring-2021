...
```
```{r, include=FALSE}
register_google(key = "AIzaSyCVRE8syocGlzCnfOLYs96VTIl-P9F7Qig") ### use your own API. 
```

```{r, eval=FALSE}
register_google(key = "YOUR KEY HERE") ### use your own API
#IMPORTANT don't put your key to github!! I ussually save mine in a text file and import it each time
```
...
<img src = "https://adsteen.github.io/data_analysis_2020/homework/2020-09-23-homework-7-badplot_files/rihanna_plot.jpeg", width=50%/>
---
