...
[rdocumentation.org](rdocumentation.org)  
[rseek.org](rseek.org)  
...
- "#rstats" on twitter - no seriously, create an account. Some to follow right away for maximum R learning, commentary and community: @dataandme, @hadleywickham, @drob, @RLadiesGlobal, @WeAreRLadies, @R4DScommunity, @allison_horst, @R_LGBTQ, @JennyBryan, @juliasilge, @noamross, @kara_woo, @thomas_mock, @juliesquid, @cedsherer]
