...
.pull-right[
```{r plot-labelm-out, ref.label="plot-labelm", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labeln-out, ref.label="plot-labeln", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labelo-out, ref.label="plot-labelo", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labelp-out, ref.label="plot-labelp", echo=FALSE, warning = FALSE}
```
]
---
...
.pull-right[
```{r plot-labelq-out, ref.label="plot-labelq", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labelr-out, ref.label="plot-labelr", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labels-out, ref.label="plot-labels", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labelt-out, ref.label="plot-labelt", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labelu-out, ref.label="plot-labelu", echo=FALSE, warning = FALSE}
```
]
...
.pull-right[
```{r plot-labelw-out, ref.label="plot-labelw", echo=FALSE, warning = FALSE}
```
]
---
...
.center[
[There are over 80 ggplot2 extentions](https://exts.ggplot2.tidyverse.org/gallery/)  
...
- **Due on github by Monday at 9am.**
